...
export default function Devices(){
  ...
  async function editDevice(dev_id, dev_name, dev_ip, dev_status=status, dev_url,  dev_part){
  ...
  const {values, isSubmiting, setFieldValue, handleSubmit, errors} = useFormik({
    ...
    onSubmit: values =>{
      ...
      const {id, name, ip, device, status, url} = values;
      const response = editDevice(id, name, ip,  status, url, device);
